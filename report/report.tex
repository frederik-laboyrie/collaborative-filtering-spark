...
[p. 350 dl]
For instance, a 2-dimensional kernel which can be expressed as an outer product of 2 vectors, one in the x direction and one in the y direciton, would be a separable kernel. It is equivalent to construct 2 one d vectors to the conv \\
